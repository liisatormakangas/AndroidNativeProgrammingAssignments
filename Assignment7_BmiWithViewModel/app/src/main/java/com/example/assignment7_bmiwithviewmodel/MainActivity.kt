...
import com.example.assignment7_bmiwithviewmodel.ui.theme.Assignment7_BmiWithViewModelTheme

class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContent {
            Assignment7_BmiWithViewModelTheme {
...
fun Bmi(bmiViewModel: BmiViewModel = viewModel()) {
    ...
    Column(
        ...
        Text(stringResource(R.string.bmi, String.format("%.2f", bmiViewModel.bmi).replace(',', '.')))
    }
